...
import com.jeremyfeinstein.slidingmenu.lib.SlidingMenu.IOpeningMenu;
...
public class CustomViewBehind extends ViewGroup {
    ...
    private IOpeningMenu beginOpenMenu;

    public void setBeginOpenMenu(IOpeningMenu beginOpenMenu) {
        this.beginOpenMenu = beginOpenMenu;
    }
    ...
    public void scrollBehindTo(View content, int x, int y) {
        ...
        if (mMode == SlidingMenu.LEFT) {
            if (x >= content.getLeft()) {
                isBeginScroll = true;
                vis = View.INVISIBLE;
                if (beginOpenMenu != null)
                    beginOpenMenu.onCancelOpening();
            } else if (isBeginScroll) {
                if (beginOpenMenu != null)
                    beginOpenMenu.onBeginOpening();
                isBeginScroll = false;
